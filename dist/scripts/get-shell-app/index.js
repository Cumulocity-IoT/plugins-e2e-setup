...
const axios_1 = __importDefault(__nccwpck_require__(269));
/**
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getShellApp = void 0;
const download_shell_app_1 = __nccwpck_require__(4);
const extract_shell_1 = __nccwpck_require__(795);
const fs_1 = __importDefault(__nccwpck_require__(896));
const SHELL_NAMES = ['cockpit', 'devicemanagement', 'administration'];
async function getShellApp({ shellName, shellVersion, shellPath }) {
    if (!shellName) {
...
exports.getShellApp = getShellApp;
...
const FormData$1 = __nccwpck_require__(454);
const url = __nccwpck_require__(16);
const proxyFromEnv = __nccwpck_require__(777);
const http = __nccwpck_require__(611);
const https = __nccwpck_require__(692);
const util = __nccwpck_require__(23);
const followRedirects = __nccwpck_require__(573);
